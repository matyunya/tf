...
import "https://cdn.jsdelivr.net/npm/@tensorflow/tfjs-vis@1.4.3/dist/tfjs-vis.umd.min.js";
export { predict } from '/predict.js';
import canvas from '~matyunya/draw-canvas/index.js';

export const tf = window.tf;
export const tfvis = window.tfvis;
export { canvas };
...
async function train(model, data) {
  ...
  const container = {
    name: 'Model Training', styles: { height: '500px' }
  };
...
export function resize(imageData, scale = 0.5) {
